...
draw_self()
draw_text(220, 30, string(global.version) + string(global.version_tag));
if global.patch = "on"
{
	if(!(global.latest_ver == "default"))
	{
	var l38E70F88_0 = false;
	l38E70F88_0 = instance_exists(VersionInfoButton);
	if(!l38E70F88_0)
	{
		instance_create_layer(400, 90, "Instances_8", VersionInfoButton);
	}
		draw_text_transformed(220, 90, string("Latest Version ") + string(global.latest_ver) + string(global.latest_tag),.6,.6,0)
	}

	else
	{
		draw_text_transformed(220,90,"Offline",.6,.6,0)
	}
}