...
if(l27D9BCA3_0)
{
	draw_sprite_ext(Main_controll.title_logo, 0, 500, 700, 0.2, 0.2, 0, $FFFFFFFF & $ffffff, ($FFFFFFFF >> 24) / $ff);

}
var l27D9BCA3_0 = file_exists(global.theme_dir + "/splash.png");
if(l27D9BCA3_0)
{
	draw_sprite_ext(Main_controll.splash, 0, 950, 700, 0.2, 0.2, 0, $FFFFFFFF & $ffffff, ($FFFFFFFF >> 24) / $ff);

}
var l27D9BCA3_0 = file_exists(global.theme_dir + "/loading.png");
if(l27D9BCA3_0)
{
	draw_sprite_ext(Main_controll.loading, 0, 1400, 700, 0.2, 0.2, 0, $FFFFFFFF & $ffffff, ($FFFFFFFF >> 24) / $ff);

}
var l27D9BCA3_0 = file_exists(global.theme_dir + "/office.png");
if(l27D9BCA3_0)
{
	draw_sprite_ext(Main_controll.office, 0, 1220, 100, 0.2, 0.2, 0, $FFFFFFFF & $ffffff, ($FFFFFFFF >> 24) / $ff);

}
var l27D9BCA3_0 = file_exists(global.theme_dir + "/logo.png");
if(l27D9BCA3_0)
{
	draw_sprite_ext(Main_controll.logo, 0, 60, 700, 0.8, 0.8, 0, $FFFFFFFF & $ffffff, ($FFFFFFFF >> 24) / $ff);
